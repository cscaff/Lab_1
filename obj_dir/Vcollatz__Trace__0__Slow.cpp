...
VL_ATTR_COLD void Vcollatz___024root__trace_register(Vcollatz___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vcollatz___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vcollatz___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vcollatz___024root__trace_chg_0, 0, vlSelf);
